...
STEPS:
------
1. Download than unzip the project folder
...
To run the project type the following command:
	...
	python gad.py --image <your_image_name>.jpg
...
Note:
-----
You'll find a several images examples within the project that you can work with or with your own images.